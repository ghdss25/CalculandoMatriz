...
public class ver_multiplicacao_matriz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_multiplicacao_matriz);

        Intent i = getIntent();
        TextView t[] = new TextView[10];

        int mult[] = i.getIntArrayExtra("Extra");
        int j;
