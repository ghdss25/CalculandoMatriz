...
public class ver_divisao_matriz extends AppCompatActivity {

    @RequiresApi(api = Build.VERSION_CODES.Q)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ver_divisao_matriz);

        Intent i = getIntent();
        TextView t[] = new TextView[10];

        int div[] = i.getIntArrayExtra("Extra");
        int j;
